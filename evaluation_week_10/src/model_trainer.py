# RUNNING COMMAND: py -3.12 src/model_trainer.py
# =============================================================
...
def train():
    ...
    with open(DATASET_PATH, 'r') as f:
        dataset = json.load(f)[:20]  # LIMIT TO 20 ENTRIES FOR FAST COMPLETION
    ...
    training_args = Seq2SeqTrainingArguments(
        ...
        num_train_epochs         = 1,          # Fast pass
        per_device_train_batch_size = 8,       # 8 examples at a time
